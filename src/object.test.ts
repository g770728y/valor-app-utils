...
describe.only('deepRenameProps', () => {
  it('default', () => {
    // expect(deepRenameProps({ a: 1, b: 2 }, { a: 'a1' })).toEqual({ a1: 1, b: 2 });
    // expect(deepRenameProps({ a: 1, b: 2 }, { a: 'a1', b: 'b1' })).toEqual({ a1: 1, b1: 2 });
    // expect(deepRenameProps({ a: 1, b: 2 }, { a: 'a1', b: 'a1' })).toEqual({ a1: 2 });
    // expect(deepRenameProps({ a: 1, b: 2 }, { a: 'a1', b: 'a1', c: 'c1' })).toEqual({ a1: 2, c1: undefined });
  });

  it('deep', () => {
    expect(deepRenameProps({ a: { a: 1, b: 2 } }, { a: '_a' })).toEqual({
      _a: { _a: 1, b: 2 },
    });
    expect(
